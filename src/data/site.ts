export const site = {
  ...
  github: 'https://github.com/hoseinrza',
  telegram: 'https://t.me/Thegreatindigo',
  telegramHandle: '@Thegreatindigo',
  // No public LinkedIn yet — omitted rather than linking a placeholder.
